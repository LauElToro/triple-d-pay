...
import { O as ChartColumn, _ as LifeBuoy, c as ShieldCheck, d as Receipt, h as LogOut, l as Settings, m as Package, n as X, p as PanelLeft, r as Users, v as LayoutDashboard, y as KeyRound } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/app-2h-OZGHb.js
...
function AppSidebar() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Sidebar, {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SidebarContent, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SidebarGroup, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarGroupLabel, {
				className: "font-mono text-[10px] uppercase",
				children: "Panel"
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarGroupContent, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarMenu, { children: visible.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarMenuItem, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarMenuButton, {
				asChild: true,
			...
			}) }, item.url)) }) })] }), user?.systemRole === "SUPERADMIN" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SidebarGroup, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarGroupLabel, {
				className: "font-mono text-[10px] uppercase",
				children: "Admin"
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
					to: "/admin",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShieldCheck, { className: "h-4 w-4" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Consola global" })]
				})
			}) }) }) })] })] }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SidebarFooter, {
				...
				children: [user && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "text-xs font-mono text-slate truncate",
					title: user.id,
					children: [user.email, /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "opacity-60",
						children: activeOrg?.subRole ?? activeOrg?.orgRole ?? user.systemRole
					})]
...
function AppLayout() {
	...
	(0, import_react.useEffect)(() => {
		...
		if (user.systemRole !== "SUPERADMIN" && user.kycStatus !== "APPROVED") navigate({ to: "/kyc" });
	}, [
		hydrated,
		user,
		navigate
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarProvider, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "min-h-screen flex w-full bg-paper",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AppSidebar, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "flex-1 flex flex-col",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("header", {
				className: "h-12 flex items-center border-b border-line bg-card/60 backdrop-blur px-3",
