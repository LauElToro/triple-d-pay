...
export const catalogEn: TranslationDict = {
  ...
  "footer.disclaimer":
    "Set-Api is a commercial site with no official relationship to government agencies.",
  ...
  "landing.connectDesc":
    "Skip ARCA complexity. With Set-Api you integrate in minutes and focus on growing your business.",
  ...
  "landing.statsCuitsPeriod": "operating with Set-Api in the last 30 days",
  "landing.facturaTitle": "Need end-to-end invoicing?",
  "landing.facturaDesc":
    "Set-Api Factura handles emission, states, PDFs, QR and webhooks for SaaS, ERPs and platforms.",
  "landing.facturaCta": "Discover Set-Api Factura",
  ...
  "docs.delegation": "ARCA delegation",
  "docs.delegationDesc":
    "Customer and Set-Api steps to delegate Web Services in production (POS, F.3283/E and Fiscal Computer).",
  "docs.delegationCta": "Read the full guide",
  "docs.delegation.client": "Customer",
  "docs.delegation.attention": "Attention",
  "docs.webServices": "Web services",
  "docs.automations": "Automations",
  "docs.quickstartTitle": "Get started in minutes",
  "docs.quickstartDesc": "Use the REST API, set your API Key and issue your first voucher.",
  ...
  "docs.integrationHint":
    "Use your Set-Api API Key. The REST API handles authentication and ARCA-compatible payloads.",

  "pricing.title": "Pricing",
  "pricing.subtitle": "Simple plans. Change anytime from the dashboard.",
  "pricing.cta": "Get started",
  "pricing.custom.name": "Custom",
  "pricing.custom.price": "Tailored",
  "pricing.custom.tagline": "For volumes or needs beyond our standard plans",
  "pricing.custom.feature0": "Limits and quotas above the standard plans",
  "pricing.custom.feature1": "Commercial terms agreed with you",
  "pricing.custom.feature2": "Support and guidance for your use case",
  "pricing.custom.feature3": "We design the plan together around your operation",
  ...
  "tools.requiresApi": "Requires a Set-Api API Key for live queries.",
  ...
  "catalog.ws.comprobantes-turismo.howto":
    "Configure the operator CUIT, enable the tourism service and issue via REST with trip/service data. Validate in homologation before production.",
  ...
  "catalog.ws.factura-exportacion.howto":
    "Build the payload with exporter, buyer and goods/services detail; emit via REST and store CAE plus response for filing and shipping.",
  ...
  "catalog.ws.carta-porte.howto":
    "Define origin, destination, product and transport data; issue or query via REST. Persist the official id for tracking and roadside controls.",
  ...
  "catalog.ws.factura-mipyme.howto":
    "Issue or query MiPyME invoices via REST with regime and voucher data. Use response statuses and due dates in your collections flow.",
  ...
  "catalog.auto.delegar-ws.desc": "A CUIT authorizes Set-Api to use a web service on its behalf.",
  "catalog.auto.delegar-ws.body":
    "In production the customer delegates each WS from the Relationships Administrator to Set-Api’s CUIT, with a Web Services POS and F.3283/E certificate. See the full guide at /docs/delegacion-arca (example data only).",
  "catalog.auto.delegar-ws.howto":
    "Follow Part A of the guide: RECE POS first, then New Relationship per service, and send F.3283/E to Set-Api.",
  "catalog.auto.delegar-ws.requirements":
    "Fiscal Key level 3, company CUIT, Web Services POS and Set-Api representative CUIT.",
  "catalog.auto.aceptar-delegacion.title": "Accept WS delegation",
  "catalog.auto.aceptar-delegacion.desc": "Set-Api accepts designations and assigns the Fiscal Computer.",
  "catalog.auto.aceptar-delegacion.body":
    "Part B of the guide: accept designations, sub-delegate to the production certificate and configure the CUIT on the account. Without that stage ARCA may respond “Computer not authorized”.",
  "catalog.auto.aceptar-delegacion.howto":
    "See /docs/delegacion-arca — Set-Api checklist and a no-side-effect verification call.",
  "catalog.auto.aceptar-delegacion.requirements":
    "Pending customer designation, F.3283/E certificates and production Fiscal Computer.",
